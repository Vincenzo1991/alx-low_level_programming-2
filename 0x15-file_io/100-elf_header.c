 ...
 * @e_ident: A pointer to an array which contains ELF magic numbers.
 ...
 * @e_ident: A pointer to an array which contains the ELF data.
 */
void print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
 ...
 * @e_ident: A pointer to an array which contains the ELF OSABI.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident: A pointer to an array which contains the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array which contains the ELF type.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @e_ident: A pointer to an array which contains the ELF entry point.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @fds: The file descriptor of the ELF file.
 * If the file cannot be closed - exit code 98.
 */
void close_elf(int fds)
{
	if (close(fds) == -1)
	{
